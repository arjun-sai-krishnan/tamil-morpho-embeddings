...
if __name__ == '__main__':
    print("Keys")
    print(extract_keys('analogies/relation_key.txt'))
    print("Dset alone")
    print(extract_dset('analogies/full_dataset/pairs.txt'))
    print("Dset with keys")
    print(extract_dset('analogies/full_dataset/pairs.txt', 'analogies/relation_key.txt'))